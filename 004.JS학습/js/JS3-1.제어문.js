...
function showJumsu() {
  ...
  // 조건범위 : 0보다 작거나 100보다 크면 true
    ...
    console.log("점수범위가 아닙니다");

    // 초기화하기 ////////////
    // (1) 텍스트 변경하기
    jexp.innerText = "0~100 사이숫자만 입력해주세요";
    // (2) 글자색 변경하기
    jexp.style.color = "black";
    // (3) 칭찬스티커 변경하기
    jshow.style.backgroundPosition = "-50% 0%";
  ...
  // -> 공백만 쓰면 공백자체가 제거된다!
    ...
    console.log("비어있습니다. 입력해주세요.");

    // 초기화하기 ////////////
    // (1) 텍스트 변경하기
    jexp.innerText = "값을 꼭 입력해주세요";
    // (2) 글자색 변경하기
    jexp.style.color = "black";
    // (3) 칭찬스티커 변경하기
    jshow.style.backgroundPosition = "-50% 0%";
...
////////////////
//switch문 연습
// 여기서 직접 요소에 이벤트를 설정해보자
// 함수 바깥영역은 바로 실행되므로 이 파일을 불러오는
// 설정에서 속성으로 defer를 써서 코딩해야한다
...
// 주의해야 할 점은 선언된 함수를 할당할 때,
// 뒤에 소괄호를 하지 말아야한다. 이유는 바로 실행되기 때문이다
...
// DOM 선택이 된 이유는 외부 JS 호출 시 defer로 호출했기 때문에
// html태그 로딩 후 실행된다
