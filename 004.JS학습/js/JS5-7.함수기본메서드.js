...
// 2. 나라 동물 찍기
exBox[2].innerText = 대표동물.발표.call(
  동물1,
  "오세아니아",
  "유대류"
);
...
// apply(객체, 배열) -> 앞에 객체값을 불필요해서 null보낸다
// 뒤에 배열만 필요하고 이것을 보내서 최대값/최소값을 리턴한다
// 단순배열
...
exBox[7].innerText = myNum+'의 최소값:'+Math.min.apply(null, myNum);
...
// -> bind는 객체를 묶어보내는 역할만 하고 실행은 뒤에 소괄호가 한다
