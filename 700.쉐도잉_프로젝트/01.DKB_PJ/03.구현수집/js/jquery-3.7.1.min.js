...
!(function (e, t) {
  ...
  function (ie, e) {
    ...
    (ce.fn = ce.prototype =
      ...
      ce.extend({
        expando:
          "jQuery" + (t + Math.random()).replace(/\D/g, ""),
        isReady: !0,
        error: function (e) {
          throw new Error(e);
        },
    ...
    (xe = C.createDocumentFragment().appendChild(
      ...
      (be = C.createElement("input")).setAttribute(
        "type",
        "radio"
      ),
      ...
      (le.noCloneChecked = !!xe.cloneNode(!0).lastChild
        .defaultValue),
    ...
    var _e = new RegExp("^(" + G + ")(?!px)[a-z%]+$", "i"),
      ...
      Xe = function (e) {
        ...
        return (
          (t && t.opener) || (t = ie), t.getComputedStyle(e)
        );
      },
      Ue = function (e, t, n) {
        var r,
    ...
    (ce.Animation = ce.extend(yt, {
      ...
      prefilters: [
        function (e, t, n) {
          ...
          for (r in (n.queue ||
            (null ==
              (a = ce._queueHooks(e, "fx")).unqueued &&
              ((a.unqueued = 0),
              (s = a.empty.fire),
    ...
    ce.parseXML = function (e) {
      ...
      try {
        t = new ie.DOMParser().parseFromString(
          e,
          "text/xml"
        );
      } catch (e) {}
      ...
      ce.fn.extend({
        ...
        position: function () {
          if (this[0]) {
            ...
            return {
              top:
                t.top - i.top - ce.css(r, "marginTop", !0),
              left:
                t.left -
                i.left -
